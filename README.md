...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/round-tooth-755b)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/round-tooth-755b
```

A live public deployment of this template is available at [https://round-tooth-755b.templates.workers.dev](https://round-tooth-755b.templates.workers.dev)
